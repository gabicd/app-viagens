import { NunitoSans_300Light, NunitoSans_500Medium, NunitoSans_600SemiBold, NunitoSans_700Bold } from "@expo-google-fonts/nunito-sans"; // Sua fonte
  ...
  return (
    <View style={{ flex: 1 }} onLayout={onLayoutRootView}>
      <Stack>
        ...
        <Stack.Screen name="roteiro_selecionado" options={{ headerShown: false }} />
      </Stack>
    </View>
  );
}
